...
Full-featured browser with tabs, settings, and theme switching
"""
...
class BenedictBrowser(QMainWindow):
    ...
    def create_toolbar(self):
        ...
        self.forward_btn.setFont(QFont("Arial", 16, QFont.Bold))
        ...
        self.reload_btn.setFont(QFont("Arial", 18, QFont.Bold))
        ...
        self.home_btn.setFont(QFont("Arial", 18, QFont.Bold))
        ...
        self.settings_btn.setFont(QFont("Arial", 18, QFont.Bold))
